# BMT Dorm Mattresses (JBSA Lackland) — Sources Sought → quote
...
| Owner | Blake |
| Fit score | 100 — core product, in-region (Lackland TX, ~3 h from Houston plant) |
| Risk level | low |
| Estimated value | TBD (1,000 units + delivery/install) |
...
| # | Requirement |
| --- | --- |
| 1 | 36" W × 75" L × 6–8" thick, color royal blue |
| 2 | Polyurethane-coated nylon fabric, 4-way stretch and recovery, abrasion resistant, breathable |
| 3 | Silver ion antimicrobial integrated in the fabric (MRSA, body fluids, bacteria; "99.99%") |
| 4 | Welded sealed-seam construction, zero thread seams, all seams inside; fluid-proof, tamper-resistant |
| 5 | Usable without a sheet/cover; easily cleaned and disinfected |
| 6 | "Max-life" fiber core (no springs); lightweight |
| 7 | Fire: 16 CFR 1632, 16 CFR 1633, and California TB 129 (high-risk occupancy) |
| 8 | Delivery + installation onto **empty bed frames**; **no removal** of old mattresses |

Source: notice <https://sam.gov/workspace/contract/opp/82d016fd8cbd427f9fe3d7a073fea0ed/view>.

## 2. Fit assessment

- **Product fit:** a sealed welded-seam coated-nylon fiber-core institutional unit, not the
  innerspring build quoted for JBSA Bldg 6578 / CRTC. Operator confirmed 2026-09-15 that CSP
  can produce it: welded sealed cover, TB 129 test path, fiber core all in range.
- **Spec wording reads as vendor catalog copy** ("Silver Ion Technology", "Max-life fiber
  core", "Zero thread seams"); expect a brand-name-or-equal RFQ. Equal is achievable if the
  three gates above hold.
- **Open spec question:** silver ion specifically vs. an equivalent medical-grade antimicrobial
  cover (asked 09-15; affects fabric sourcing and price). Thickness preference within 6–8"
  also asked (CSP recommended 7–8").
...
- **2026-09-15** — Initial capability response sent from silverlinesleep to Ariana Trevino
  (primary) and SrA Colten Paynter (secondary).
- **2026-09-15** — Buyer replied: dimensions per Salient Characteristics (36×75×6–8"), no
  removal, small business prioritized, asked for specs + capability statement + quote.
  Sent the Salient Characteristics PDF and Appendix A.
...
- Price at 1,000 qty: unit cost (6/7/8" fiber core, welded coated-nylon cover, with and
  without silver-ion fabric), freight Houston → Lackland (2–3 truckloads), install crew days.
- Deliverables with the quote: one-page spec sheet for the 36×75 unit, characteristic-by-
  characteristic compliance table, TB 129 / 16 CFR 1632 / 1633 documentation.
- Label pricing **budgetary** until an RFQ posts; quote validity 60 days.
- Draft email text, compliance matrix, and checklist:
  [`docs/drafts/jbsa_bmt_dorm_mattresses_FA301626Q7145.md`](../../docs/drafts/jbsa_bmt_dorm_mattresses_FA301626Q7145.md).

## 5. Contacts

- Ariana Trevino — ariana.trevino@us.af.mil (primary)
- SrA Colten Paynter — colten.paynter@us.af.mil (secondary)
- Office: FA3016 502 CONS CL, 1655 Selfridge Ave Bldg 5450, JBSA Lackland TX 78236-5286

## 6. Related

- Same office's July 2026 Sources Sought F2M3CH6099A001 (Tech Training Dorm Mattresses,
  Bldg 6578; innerspring Twin XL) — CSP responded 2026-07-02; row still watching for its RFQ.
