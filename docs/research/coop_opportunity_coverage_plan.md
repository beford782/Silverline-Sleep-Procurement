...
| Choice Partners / HCDE | Official per-opportunity email (HCDE eBid / IonWave) | Finish the paused registration only if the UEI field can stay blank or after SAM/FSD confirms a valid LLC UEI; select FF&E + mattress/bedding + dormitory + household-goods codes; email purchasing@hcde-texas.org to confirm 23/022MF expiry | High |
